...
- **Owner / phase:** `maintainer/phases/extractor.md` §0 (C.1.3); tests in `packages/core/src/extractor/shared/__tests__/calls.test.ts`.
...
- **Owner / phase:** `maintainer/phases/extractor.md` §0 “Patterns NOT handled”; `docs/extractor/README.md` limits.
