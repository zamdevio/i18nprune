...
import { tryResolveTemplatePrefixBeforeUnknown } from '@/core/extractor/dynamic/rebuild.js';
import { findTranslationCallSites } from '@/core/extractor/calls.js';
import { offsetInCommentRanges } from '@/core/extractor/dynamic/comment.js';
import type { KeyObservation, SourceSpan } from '@/types/core/extractor/keySites/index.js';
import { lineNumberAtIndex } from '@/core/extractor/keySites/line.js';
...
/**
 * Scan merged source text for translation call patterns; emit structured observations.
 * Matches {@link exactLiteralKeys} resolution rules (quoted literals + backtick templates).
 */
...
/** Resolved dotted keys suitable for sets / parity with {@link exactLiteralKeys}. */
