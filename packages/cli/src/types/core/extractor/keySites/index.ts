 ...
 * Heuristic dynamic sites stay {@link DynamicKeySite} under `types/core/extractor/dynamic`.
 */
...
/**
 * Folded summary of {@link KeyObservation} rows for usage detection (`cleanup`, `missing`, reference rules).
