...
const snapshotJson = path.join(snapshotDir, 'sync.parity.json');
const snapshotStderr = path.join(snapshotDir, 'sync.parity.stderr.txt');

describe('sync parity (sample-i18n)', () => {
  beforeAll(() => {
