...
**👉 Read the agent guide:** **[Agents README](../agents)** — full **[project analysis](../agents/analysis.md)** (architecture map), **[Git commit plan](../agents/git.md)** (how to slice commits: command + matching docs), **[rules](../agents/rules.md)**, logging, and extraction notes.
...
- [Workflow](../workflow) — local commands
- [Roadmap](../roadmap) — product direction
- [Exports](../exports) — programmatic API
