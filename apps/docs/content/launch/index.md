...
| **Proof** | Sample report or screenshot; commands page stays copy-paste first; landing polish follows **`apps/web`** milestones and repo roadmap (**`maintainer/V1-RELEASE.md`** path — maintainer-only) |
...
3. **Differentiator block:** same primitives as CLI → `i18nprune/core` (2–3 bullets).
4. **Move long tables** lower or link to docs site to reduce scroll fatigue.
5. **Story (optional):** link [Origin](../origin) / [Cursor](../cursor) at end, not at top.
...
| Doc | Role |
|-----|------|
| [Origin](../origin) | Why the project exists |
| [Cursor](../cursor) | How the repo was built (tooling narrative) |
| VS Code extension (maintainer-only) | [`maintainer/phases/extension/README.md`](../../maintainer/phases/extension) — scheduling only |
| [Vision](../vision) | Product direction |
| [Roadmap](../roadmap) | Longer-term features |
