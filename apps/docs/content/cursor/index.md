...
→ [docs/origin/README.md](../origin)

---

## Relationship to the rest of the docs

- CLI + JSON behavior → [docs/json/README.md](../json)  
- Programmatic API → [docs/exports/README.md](../exports)  
- Command reference → [docs/commands/README.md](../commands)  
- Contributor / agent workflows → [docs/agents/README.md](../agents)
