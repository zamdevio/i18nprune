...
- [Auto-patching](../patching) — opt-in loader/config edits (when enabled)
- [Roadmap](../roadmap) — product direction (`stdout redirection`, `review`, `locales`, …)
...
- [Config](../config) — config file discovery order
