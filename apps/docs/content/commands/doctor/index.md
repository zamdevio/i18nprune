...
**Full examples:** [doctor examples](../../examples/commands/doctor)
...
Update discovery is **global** (banner + cache + **`version --check`**), not a separate `doctor` post-step. See [`docs/versioning/README.md`](../../versioning).
