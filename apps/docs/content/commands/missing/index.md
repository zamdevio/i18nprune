...
**Full examples:** [missing examples](../../examples/commands/missing)
...
| Flag | Role |
|------|------|
| **`--json`** with shell redirection** | Structured run report at end (when this command is wired into the report session). See [Examples](../../examples). |
