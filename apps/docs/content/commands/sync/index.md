...
**Full examples:** [sync examples](../../examples/commands/sync)
...
See [Locales metadata mode](../../locales/metadata) for shared writer behavior used by `sync`/`generate`/`fill`.
...
For practical filters, see the [jq cookbook](../../examples/jq-cookbook).

## Planned: `sync meta` subcommand

**Not implemented yet** — see [Roadmap](../../roadmap) (“Planned: `sync meta` subcommand”).
