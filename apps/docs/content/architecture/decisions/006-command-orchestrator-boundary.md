...
**Physical layout:** within `packages/cli/src/commands/<name>/`, prefer **`index.ts`** for re-exports and **`run.ts`** for the primary handler, with optional co-located orchestration-only helpers — see [Command orchestration boundary — file layout](../../commands/orchestration#file-layout-inside-a-command-package).
...
- [Command orchestration boundary](../../commands/orchestration)
- [Command orchestration README](../../commands/orchestration)
- [`docs/exports/` hub](../../exports)
