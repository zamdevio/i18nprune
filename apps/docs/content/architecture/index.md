...
| Topic | Where |
|-------|--------|
| **JSON / `--json`** | [JSON output (`--json`)](../json), [programmatic API & CLI JSON](../json/programmatic.md) |
| **Command vs `core` layout** | [Command orchestration boundary](../commands/orchestration), [ADR 006](./decisions/006-command-orchestrator-boundary.md) |
| **CLI prompts** | [CLI prompt modules](../cli/prompts) |
| **Translator & progress** | [Translator engine](../translator), [Translation progress](../progress) |
| **Loader & user i18n wiring** | [Loader & config](../patching/loader.md), [patching overview](../patching) |
| **Project tree** | [tree](./tree) |
| **Languages catalog** | [languages](./languages) |
