...
| Topic | Doc |
|-------|-----|
| **How this repo was built** (Cursor, agent passes, usage limits, human direction) | [Cursor & tooling](../cursor) |
| **Vision** — where the product is headed | [Vision](../vision) |
| **Roadmap** | [Roadmap](../roadmap) |
| **Contributing** | [Contributing](../contributors) |
| **Agents & repo onboarding** | [Agents](../agents) |
| **Docs index** (commands, JSON, exports, …) | [Documentation home](..) |