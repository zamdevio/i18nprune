...
The headings below exist so **`docHref`** anchors (e.g. `#config-parse-failed`) resolve on this page. See [patching overview](../patching) and [loader contract](../patching/loader.md).
