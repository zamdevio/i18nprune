...
If you want the drier technical origin, see [`docs/origin/README.md`](../origin). If you want the meta story about tooling and Cursor accelerating the grind — without replacing human decisions — see [`docs/cursor/README.md`](../cursor).
