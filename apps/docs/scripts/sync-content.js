...
/** Next.js app root (`apps/docs`). */
const NEXTRA_DIR = resolve(__dirname, '..')
/** Repository root — script lives at `apps/docs/scripts/` (three levels below root). */
const REPO_ROOT = resolve(__dirname, '../../..')
/** Authoritative markdown under repo `docs/` (not `apps/docs/`). */
...
/** Top-level names under `docs/` that are not copied to the Nextra site (optional; empty = mirror all of `docs/`). */
