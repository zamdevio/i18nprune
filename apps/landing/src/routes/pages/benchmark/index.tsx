...
import { getDocsUrl, githubTree, LINKS } from "../../../constants/links";
      ...
      <div className="mx-auto max-w-6xl space-y-10 px-4 pt-8 sm:space-y-12 sm:px-6 sm:pt-12">
        ...
        <section className="reveal rounded-xl border border-border bg-card p-5 sm:p-8 md:p-10">
          ...
          <div className="mt-6 flex flex-col gap-3 border-t border-border/70 pt-6 sm:flex-row sm:items-start sm:justify-between">
            ...
            <div>
              ...
              <ul className="mt-2 space-y-1.5 text-sm">
                <li>
                  <DocLink href={getDocsUrl("regex/extraction")}>Translation call extraction</DocLink>
                </li>
                <li>
                  <DocLink href={getDocsUrl("barriers/dynamic-keys")}>Dynamic keys barrier</DocLink>
                </li>
                <li>
                  <DocLink href={getDocsUrl("dynamic")}>Dynamic scan overview</DocLink>
                </li>
              </ul>
            </div>
            <div>
        ...
        <section className="reveal scroll-mt-24 rounded-xl border border-dashed border-sidebar-primary/40 bg-sidebar-primary/5 p-5 sm:p-8 md:p-10">
          ...
          <p className="mt-3 text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            <code className="font-mono text-xs">--format json|csv|text</code> for data exports. See{" "}
            <DocLink href={getDocsUrl("json/README#report-json-on-disk-vs-cli-json-stdout")}>report JSON vs CLI JSON</DocLink> and{" "}
            <DocLink href={getDocsUrl("commands/report/README")}>report command</DocLink>. Run{" "}
