...
import { COMMAND_CATEGORIES, primaryDocHref } from "./data";
    ...
    >
      <div className="flex flex-col gap-2 border-b border-border/80 pb-4 md:flex-row md:items-start md:justify-between">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="mt-2 inline-flex shrink-0 items-center gap-1.5 rounded-md border border-border px-3 py-2 text-xs font-semibold text-foreground transition-colors hover:border-sidebar-primary hover:bg-secondary/50 md:mt-0"
        >
          Command docs
