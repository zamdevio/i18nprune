      ...
      <div className="mx-auto w-full max-w-6xl space-y-8 px-4 pt-8 sm:space-y-10 sm:px-6 sm:pt-12 lg:max-w-7xl">
        <section className="reveal w-full rounded-xl border border-border bg-card p-5 sm:p-8 md:p-10 lg:p-12">
          ...
          <p className="mt-3 max-w-none text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            <DocLink href={docsUrl("barriers/dynamic-keys")}>dynamic keys</DocLink>. Use{" "}
            <code className="font-mono text-xs">validate --json</code> when a machine report should drive the next step (
            <code className="font-mono text-xs">missing --from-report</code>).
          </p>
        </section>
        ...
        <section className="reveal reveal-delay-1 w-full rounded-xl border border-border bg-card p-5 sm:p-8 md:p-10 lg:p-12">
          ...
          <p className="mt-3 max-w-none text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            <DocLink href={docsUrl("commands/generate/README")}>generate</DocLink> /{" "}
            <DocLink href={docsUrl("commands/fill/README")}>fill</DocLink>.
          </p>
        </section>
        ...
        <section className="reveal reveal-delay-2 w-full rounded-xl border border-border bg-card p-5 sm:p-8 md:p-10 lg:p-12">
          ...
          <p className="mt-4 max-w-none text-sm leading-relaxed text-muted-foreground md:text-base">
            <strong className="font-medium text-foreground">What:</strong> emit HTML/JSON/CSV/text reports and per-run{" "}
            <code className="font-mono text-xs">--report-file</code> JSON; re-run{" "}
            <code className="font-mono text-xs">validate --json</code> as the gate.
          </p>
          <p className="mt-3 max-w-none text-sm leading-relaxed text-muted-foreground md:text-base">
          ...
          <p className="mt-3 max-w-none text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            <DocLink href={docsUrl("report/README")}>report UI</DocLink>,{" "}
        ...
        <section className="reveal w-full rounded-xl border border-border bg-card p-5 sm:p-8 md:p-10 lg:p-12">
          ...
          <p className="mt-3 max-w-none text-sm leading-relaxed text-muted-foreground md:text-base">
            ...
            trust JSON output. <DocLink href={docsUrl("commands/config/README")}>config</DocLink> prints merged values;{" "}
            <DocLink href={docsUrl("commands/doctor/README")}>doctor</DocLink> checks Node, ripgrep, paths, and optional{" "}
        ...
        <section className="reveal w-full rounded-xl border border-dashed border-border bg-secondary/20 p-5 sm:p-8 md:p-10 lg:p-12">
          ...
          <ul className="mt-4 max-w-none list-inside list-disc space-y-2 text-sm text-muted-foreground md:text-base">
            <li>
              Install CLI; run <DocLink href={docsUrl("commands/doctor/README")}>doctor</DocLink> locally until clean for
              your matrix.
            </li>
            <li>
            ...
            <li>
              Long-running or interactive flows: <DocLink href={docsUrl("behavior/json-long")}>JSON + long runs</DocLink>.
            </li>
          </ul>
          <div className="mt-8">
