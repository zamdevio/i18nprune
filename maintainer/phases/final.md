...
- [ ] Close or defer open slices in **`docs.md`** per release scope (platform + tree T0–T10 + CI CI-1–5 shipped — [`systems/platform.md`](../systems/platform.md), [`systems/ci.md`](../systems/ci.md), [`shipped-slices.md`](./shipped-slices.md)).
