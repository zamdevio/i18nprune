...
**Who:** canonical primitives named in any phase doc (`extractor.md`, future). Internal but load-bearing.
...
4. **Reference plan docs by path** (e.g., `maintainer/phases/extractor.md`) so the file points back to the locked source of truth instead of carrying a competing copy.
