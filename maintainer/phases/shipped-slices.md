...
| **Share (C.3+)** — core `share.json` load/save + self-heal + worker envelope mapping + **`runShare`** project/report payload validation + `run.share.*` events | Shipped (tracker rows 0–2) | [`apps.md`](./apps.md) |
