...
| **Share (C.3+)** — core `share.json` + **`runShare`** payloads + list/view/delete + **`core/project/parseZip`** + shared project/worker types in `types/project/*` | Shipped (tracker rows 0–4) | [`apps.md`](./apps.md) |
