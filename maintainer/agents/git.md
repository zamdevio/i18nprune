...
- [ ] After deploys, IndexNow (manual — **not** on git push): `indexnow:releases --version X.Y.Z` · `indexnow:docs` · `indexnow:landing` · `indexnow:git` (see `apps/releases/scripts/MAINTAINERS.md`)
